...
| Return value |  | String | 40-character SHA1 that uniquely identifies the bundle. |
...
| Return value |  | Object | The same as the input `args`. This is so that chained transformers of this function have easy access to both the module and the update function. |
