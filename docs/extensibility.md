...
| --- | ---- | ---- | ----------- |
| Parameter | **bundles** | Stream | Bundles generated by [generateBundles](#getbundles). |
| Return value |  | Promise | Compilation object. |


This Pluggable's definition can be found [here](../src/compile/index.js#L55-L67).
...
|     | Name | Type | Description |
| --- | ---- | ---- | ----------- |
| Return value |  | Promise | compilation Resolves to the compilation output. |


This Pluggable's definition can be found [here](../src/compile/index.js#L74-L82).
...
This Pluggable's definition can be found [here](../src/compile/index.js#L20-L28).
...
This Pluggable's definition can be found [here](../src/compile/index.js#L31-L39).
...
This Pluggable's definition can be found [here](../src/compile/index.js#L13-L18).
