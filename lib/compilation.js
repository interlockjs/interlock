...
Compilation.prototype.compile = function compile() {
  ...
  return _.chain(this.bundles)
    .map(function (bundle) {
      ...
      return [bundle.dest, escodegen.generate(bundleAst, {comment: true})];
    })
    .object()
    .value();
};
...
Compilation.prototype.resolveAsset = function (requireStr, contextPath, ns, nsRoot) {
  var asset;
  this.cachedAssets = this.cachedAssets || {};
  ...
  return this.cachedAssets[asset.path] = this.cachedAssets[asset.path] || asset;
};
