...
Compilation.prototype.createAsset = function (overrides) {
  return _.extend({
    path: null,
    ns: null,
    nsPath: null,
...
Compilation.prototype.resolveAsset = function (requireStr, contextPath, ns, nsRoot) {
  var asset, resolved;
  this._assetsByPath = this._assetsByPath || {};
  ...
  asset = this._assetsByPath[resolved.path] || this.createAsset(resolved);
  asset = this.applyPlugins("postresolve", asset, requireStr);
  return this._assetsByPath[resolved.path] = asset;
};
