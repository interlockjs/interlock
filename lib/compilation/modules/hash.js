...
module.exports = function (options, applyPlugins) {
  return function hashModule(module) {
    var dependencyHashes, shasum;
    if (module.hash) { return module; }
    if (module.dependencies.length > 0) {
      _.each(module.dependencies, hashModule);
    }
    ...
    applyPlugins("hash", _.bind(shasum.update, shasum), module);
