...
const construct = {
   ...
   * @return {Array[ASTnode]}
   */
  loadModuleWhenReady: function constructRequireStmt (moduleHash, globalName) {
  ...
  bundle: function constructBundle (opts) {
    ...
    if (opts.urls) {
      programBody = programBody.concat(construct.urlRegistration(opts.urls, globalName).body);
    }
