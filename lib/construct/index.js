...
var runtimeTmpl = getTemplate("runtime");
var iifeTmpl = getTemplate("iife");
var requireStmtTmpl = getTemplate("require-statement");
...
var construct = module.exports = {
  ...
  urlRegistration: function constructUrlRegistration (urls) {
    var urlsAst = b.objectExpression(
  ...
  program: function constructRegimentFile (opts) {
    ...
    if (opts.modules) {
      var commonModules = opts.modules.map(function (moduleObj) {
