 ...
 *                                            options.destRoot)
 * @param   {String}    options.srcRoot       The root for interlock and root for file fetching
 *                                            paths on the client
 * @param   {String}    options.context       Interlock's working directory
 * @param   {String}    options.destRoot      The root used to generate an entry point's absolute
 *                                            output path
 * @param   {Array}     options.extensions    A list of filetypes for Interlock to read
 * @param   {String}    options.ns            A custom prefix for generated bundles
 */
